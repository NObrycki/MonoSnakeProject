...
namespace MonoSnakeGame
{
    public class EndScreen : GameWindow
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(font, "1. " + "Wyatt - 26", new Vector2(300, 200), Color.Black);
            spriteBatch.DrawString(font, "2. " + "Nick - 25", new Vector2(300, 300), Color.Black);
            spriteBatch.DrawString(font, "3. " + "Hickman - 23", new Vector2(300, 400), Color.Black);
            spriteBatch.DrawString(font, "4. " + "Matt - 10", new Vector2(300, 500), Color.Black);
