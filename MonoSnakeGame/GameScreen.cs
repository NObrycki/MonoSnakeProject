...
namespace MonoSnakeGame
{
    public class GameScreen : GameWindow
    {
        ...
        public GameScreen(Game1 g, SpriteBatch sb, Texture2D tex) : base(g, sb)
        {
            ...
            texture = g.Content.Load<Texture2D>("SnakeGrid");

            snakeBod = g.Content.Load<Texture2D>("SnakeBod");
            snakeHead = g.Content.Load<Texture2D>("SnakeHead");

            pOne = new Player(4, Color.Green, new Rectangle(300, 300, 25, 25), snakeBod, snakeHead);
